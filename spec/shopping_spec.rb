...
module Rebay2
  describe Shopping do
    before(:each) do
      ...
      @shopper.stub(:get_json_response).and_return(Rebay2::Response.new({"Ack" => "Success"}))
    end
    ...
    context "siteid" do
      ...
      it "should default siteid" do
        Rebay2::Api.default_site_id = 100
    ...
    context "when calling get_category_info" do
      ...
      it "should return a hash response" do
        @shopper.get_category_info({:CategoryID => 29223}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_category_info({:CategoryID => 29223}).success?).to be true
      end
      ...
      it "should iterate over results" do
        ...
        @shopper.stub(:get_json_response).and_return(Rebay2::Response.new(json))
    ...
    context "when calling find_products" do
      ...
      it "should return a hash response" do
        @shopper.find_products({:QueryKeywords => 'harry potter'}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.find_products({:QueryKeywords => 'harry potter'}).success?).to be true
      end
    ...
    context "when calling find_half_products" do
      ...
      it "should return a hash response" do
        @shopper.find_half_products({:QueryKeywords => 'harry potter'}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.find_half_products({:QueryKeywords => 'harry potter'}).success?).to be true
      end
    ...
    context "when calling get_single_item" do
      ...
      it "should return a hash response" do
        @shopper.get_single_item({:ItemID => 230139965209}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_single_item({:ItemID => 230139965209}).success?).to be true
      end
    end
    ...
    context "when calling get_item_status" do
      ...
      it "should return a hash response" do
        @shopper.get_item_status({:ItemID => 230139965209}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_item_status({:ItemID => 230139965209}).success?).to be true
      end
    end
    ...
    context "when calling get_shipping_costs" do
      ...
      it "should return a hash response" do
        @shopper.get_shipping_costs({:ItemID => 230139965209}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_shipping_costs({:ItemID => 230139965209}).success?).to be true
      end
    end
    ...
    context "when calling get_multiple_items" do
      ...
      it "should return a hash response" do
        @shopper.get_multiple_items({:ItemID => 230139965209}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_multiple_items({:ItemID => 230139965209}).success?).to be true
      end
    end
    ...
    context "when calling get_user_profile" do
      ...
      it "should return a hash response" do
        @shopper.get_user_profile({:UserID => 1}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.get_user_profile({:UserID => 1}).success?).to be true
      end
    end
    ...
    context "when calling find_popular_searches" do
      ...
      it "should return a hash response" do
        @shopper.find_popular_searches({:CategoryID => 1}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.find_popular_searches({:CategoryID => 1}).success?).to be true
      end
    ...
    context "when calling find_popular_items" do
      it "should return a hash response" do
        @shopper.find_popular_items({:CategoryID => 1}).class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.find_popular_items({:CategoryID => 1}).success?).to be true
      end
    ...
    context "when calling find_reviews_and_guides" do
      it "should return a hash response" do
        @shopper.find_reviews_and_guides.class.should eq(Rebay2::Response)
      end

      it "should succeed" do
        expect(@shopper.find_reviews_and_guides.success?).to be true
      end
